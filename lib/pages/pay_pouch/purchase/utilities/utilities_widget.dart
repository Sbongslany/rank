...
import 'utilities_model.dart';
export 'utilities_model.dart';

class UtilitiesWidget extends StatefulWidget {
  const UtilitiesWidget({super.key});

  @override
  State<UtilitiesWidget> createState() => _UtilitiesWidgetState();
}

class _UtilitiesWidgetState extends State<UtilitiesWidget>
    with TickerProviderStateMixin {
  late UtilitiesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UtilitiesModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: UtilitiesCall.call(
        jwt:
            'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJTbWFydGNhbGwgUkVTVGZ1bCBXZWJzZXJ2aWNlIiwibmJmIjoxNzE0Mzc0MDgwLCJjbGllbnRVc2VybmFtZSI6InJhbmtmaW5hbmNlIiwiY2xpZW50SVAiOiIxNTQuMTE3LjE0Ny4yMTgiLCJpc3MiOiJzbWFydGNhbGwuY28uemEiLCJ1biI6ImxIbWx4L1hNIiwiZXhwIjoxNzE0NDYwNDkwLCJpYXQiOjE3MTQzNzQwOTB9.DbzgPmnhkAiKXU_23vzde8lLO6UCaWRFbCeUI-KObNs',
      ),
      builder: (context, snapshot) {
        ...
        final utilitiesUtilitiesResponse = snapshot.data!;
                      ...
                      children: [
                                ...
                                child: FlutterFlowDropDown<String>(
                                  controller:
                                      _model.mobileNetworkValueController ??=
                                          FormFieldController<String>(null),
                                  options: UtilitiesCall.networkDescription(
                                    utilitiesUtilitiesResponse.jsonBody,
                                  )!,
                                  onChanged: (val) => setState(
                        ...
                        if (_model.mobileNetworkValue == 'Vodacom')
                          Padding(
                            ...
                            child: FlutterFlowDropDown<String>(
                              controller: _model
                                      .prePaidAirtimeVodacomValueController ??=
                                  FormFieldController<String>(null),
