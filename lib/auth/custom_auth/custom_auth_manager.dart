...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    rankAuthUserSubject.add(
      RankAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<RankAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  RankAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = RankAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    rankAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
